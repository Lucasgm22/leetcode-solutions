 ...
 * may take longer.
 *
 * push, empty = O(1) in time
 * peek pop O(1) in time amortized
 * all is O(1) in extra space
*/
...
class MyQueue {
    ...
    public int pop() {
        ...
        return !outStack.isEmpty() ? outStack.pop() : null;
    }
    ...
    public int peek() {
        ...
        return !outStack.isEmpty() ? outStack.peek() : null;
    }
